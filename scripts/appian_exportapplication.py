#------------------------------------------------
# Script name: appian_exportapplication.py
#
# Description: 
# This script starts an application export deployment
# using an application uuid.
# It monitors the deployment until it completes.
...
try: # Try to perform main logic
    ...
    parmoutputzipfile=format_file_name(parmoutputzipfile,appid=parmappid)
    print(f"Output packageZip file: {parmoutputzipfile}")
    parmoutputlogfile=format_file_name(parmoutputlogfile,appid=parmappid)
    ...
    datajson="{" + f"\"name\":\"{parmdeploymentname}\",\"description\":\"{parmdeploymentdesc}\",\"uuids\":[\"{parmappid}\"],\"exportType\":\"application\"" + "}"
    ...
    print(f"Export Information for App: {parmappid}")
    print(dashes)
